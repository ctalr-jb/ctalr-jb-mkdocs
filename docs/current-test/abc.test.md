...
- **[Update Activity](https://success.jitterbit.com/display/CS/Jitterbit+App+Builder#update-activity)**
- **[Delete Activity](https://success.jitterbit.com/display/CS/Jitterbit+App+Builder#delete-activity)**
- **[Create Activity](https://success.jitterbit.com/display/CS/Jitterbit+App+Builder#create-activity)**
- **[Query Activity](https://success.jitterbit.com/display/CS/Jitterbit+App+Builder#query-activity)**
...
<h3 id="language-codes-and-datetime-formats-for-the-locale-field">Language Codes and `Datetime` Formats for the `locale` Field</h3>
