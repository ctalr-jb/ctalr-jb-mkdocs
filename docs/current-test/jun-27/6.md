...
6. *Atividades HTTP alvo que enviam suas respostas para uma segunda atividade alvo podem enviar respostas apenas para uma mesma atividade alvo em todo o projeto. A atividade HTTP \[“Nome da Atividade Alvo 1”\] nesta operação está enviando sua resposta para várias atividades alvo por todo o projeto.*

7. *Nesta operação, o alvo dela é \[“Nome da Atividade Alvo 2A”\]. Na operação \[“Operação 2”\], o alvo dela é \[“Nome da Atividade Alvo 2B”\].*

8. *Substitua a atividade \[“Nome da Atividade Alvo 1”\] com uma atividade duplicada em uma das operações. Você pode fazer isso por encontrar a atividade \[“Nome da Atividade Alvo 1”\] na Aba Components, abrir o menu e duplicar. Arraste a atividade duplicada para a operação.*
