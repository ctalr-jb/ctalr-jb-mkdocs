[//]: # (Manual Rápido para Administradores Jitterbit)
...
Veja o artigo [Como Receber Treinamento](https://success.jitterbit.com/display/DOC/Getting+Training) para se registrar nas
...
-   **Cloud Studio**: Nosso *designer* de projetos baseado na web e
    acessado diretamente através do [Jitterbit Harmony Portal](https://success.jitterbit.com/display/DOC/Jitterbit+Harmony+Portal).
    Para ver os passos seguintes, veja o [Guia de Início Rápido com
    o Cloud Studio](https://success.jitterbit.com/display/CS/Cloud+Studio+Quick+Start+Guide).

-   **Design Studio**: Nossa aplicação para *design* de projetos para
    *desktops* que pode ser baixada no [Jitterbit Harmony Portal](https://success.jitterbit.com/display/DOC/Jitterbit+Harmony+Portal)
    e instalada em máquinas macOS ou Windows. Para ver os passos
    seguintes, veja o [Guia de Início Rápido com o Design
    Studio](https://success.jitterbit.com/display/DOC/Design+Studio+Quick+Start+Guide).
...
2.  Registre a sua conta. As instruções para o registro dependem de como
    ...
    -   **Eu fui convidado(a) para uma organização Jitterbit Harmony usando
        SSO (*single sign-on*)**: Se você foi convidado(a) por outro(a)
        usuário(a) do Jitterbit Harmony para uma organização configurada
        para [*single sign-on*, ou SSO](https://success.jitterbit.com/display/DOC/Single+Sign-On), você já estará registrado(a)
        por meio do seu Identity Provider (Provedor de Identidade).

3.  Uma vez registrado(a), você consegue fazer o seu *login* no
    [Jitterbit Harmony Portal](https://success.jitterbit.com/display/DOC/Jitterbit+Harmony+Portal) em
...
dentro do [Jitterbit Harmony Portal](https://success.jitterbit.com/display/DOC/Jitterbit+Harmony+Portal) que ajuda os administradores
...
configurados através da página [Ambientes](https://success.jitterbit.com/display/DOC/Environments) e seção [Agents](https://success.jitterbit.com/display/DOC/Agents) do
...
assistente para o [Design Studio](https://success.jitterbit.com/display/DOC/Design+Studio) e para o [Cloud Studio](https://success.jitterbit.com/display/CS/Cloud+Studio). Os
...
Dentro do assistente, assista ao vídeo de boas-vindas e a
...
-   **Run Integrations in the Cloud** (Executar Integrações na Nuvem):
    ...
    dos dois [Cloud Agent Groups](https://success.jitterbit.com/display/DOC/Cloud+Agent+Groups) do Jitterbit Harmony.
...
-   **Run Integrations On-Premises** (Executar Integrações Localmente):
    ...
    [Private Agent](https://success.jitterbit.com/display/DOC/Private+Agents) que deverá então ser baixado, instalado e
    configurado.
...
Segurança e Arquitetura da Jitterbit](https://success.jitterbit.com/display/DOC/Jitterbit+Security+and+Architecture+White+Paper).
...
-   **API URL Prefix** (Prefixo da URL da API): Coloque um prefixo que
    ...
    Manager](https://success.jitterbit.com/display/DOC/API+Manager)). O **API URL Prefix** substituirá `&lt;API-URL-Prefix&gt;`
...
-   **Cloud Agent Group** (Grupo de Agentes em Nuvem): Presente apenas
    ...
    [Cloud Agent Group](https://success.jitterbit.com/display/DOC/Cloud+Agent+Groups) que você queira associar com o ambiente:

    -   **Jitterbit Production Cloud Agent Group**: Este grupo oferece a
...
para configurar ambientes adicionais, veja [Ambientes](https://success.jitterbit.com/display/DOC/Environments).

Para as melhores práticas sobre o trabalho com ambientes na Jitterbit,
assista ao [Environments Tech Talk](https://success.jitterbit.com/display/DOC/Environments+Tech+Talk).
...
-   **Enable Cloud Logging** (Habilitar Registros na Nuvem): Os
    ...
    pode ver os dados registrados na página [Atividades](https://success.jitterbit.com/display/DOC/Activities) do
    ...
    **WARNING:** Disabling cloud logging will not prevent operation
    ...
    Logging](https://success.jitterbit.com/display/DOC/Operation+Debug+Logging). (TBT)
...
Private Agents e os Private Agent Groups, veja [Agents](https://success.jitterbit.com/display/DOC/Agents).
...
terá que baixar e instalar pelo menos um [Private Agent](https://success.jitterbit.com/display/DOC/Private+Agents) para
...
estará usando um dos [Cloud Agent Groups](https://success.jitterbit.com/display/DOC/Cloud+Agent+Groups) da Jitterbit para
executar as integrações.

Se você estiver usando os passos do assistente para o [Design
Studio](https://success.jitterbit.com/display/DOC/Design+Studio), você também terá que baixar e instalar o Design Studio, a
...
assistente para o [Cloud Studio](https://success.jitterbit.com/display/CS/Cloud+Studio), nossa próxima geração de
*designer* de projeto com experiência de usuário moderna e colaborativa
baseado na nuvem.

Informações adicionais sobre pré-requisitos, *download* e instalação do
Design Studio ou dos Private Agents estão disponíveis em [Requisitos
de Sistema](https://success.jitterbit.com/display/DOC/System+Requirements).
...
Rápido com o Cloud Studio](https://success.jitterbit.com/display/CS/Cloud+Studio+Quick+Start+Guide) ou o [Guia de Início Rápido com o Design
Studio](https://success.jitterbit.com/display/DOC/Design+Studio+Quick+Start+Guide) dependendo de qual aplicação de *design* de projeto você está
usando.
...
3.  O usuário convidado receberá então um e-mail com maiores instruções
    (veja <a
...
[Organizações](https://success.jitterbit.com/display/DOC/Organizations) e [Ambientes](https://success.jitterbit.com/display/DOC/Environments).
