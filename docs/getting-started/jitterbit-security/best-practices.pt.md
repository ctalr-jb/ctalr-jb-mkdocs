...
vez disso, use [variaveis de projeto](https://success.jitterbit.com/display/CS/Project+Variables) para armazenar informações
...
-   **Variáveis de Projeto**: Ao trabalhar com Conectores, as
    [variaveis de projeto](https://success.jitterbit.com/display/CS/Project+Variables podem proporcionar maior segurança. Se
    ...
    rel="nofollow">Usando Variaveis de Projeto
